...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.champsoft.vrms.customer.shared.exception.ResourceNotFoundException.class)
    ...
    @ExceptionHandler(com.champsoft.vrms.customer.shared.exception.DuplicateResourceException.class)
