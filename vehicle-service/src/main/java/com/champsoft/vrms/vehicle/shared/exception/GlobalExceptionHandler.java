...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.champsoft.vrms.vehicle.shared.exception.ResourceNotFoundException.class)
    ...
    @ExceptionHandler(com.champsoft.vrms.vehicle.shared.exception.DuplicateResourceException.class)
